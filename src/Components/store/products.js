...
const initailState = {
    products: [
        { name: 'xBox', category: 'Electronics', image: xbox, description: 'The Xbox is a series of video game consoles known for their gaming performance, multimedia capabilities, and online gaming services.', price: 350, stock: 5, inCart: false },
        { name: 'PlayStation', category: 'Electronics', image: PlayStation, description: 'PlayStation is a popular brand of video game consoles and related products developed and produced by Sony Interactive Entertainment, a division of Sony Corporation', price: 346, stock: 2, inCart: false },
        { name: 'PC', category: 'Electronics', image: pc, description: '"PC" is an abbreviation that stands for "Personal Computer." It refers to a broad category of computing devices designed for individual use, as opposed to larger, more specialized computers used by organizations or data centers.', price: 600, stock: 3, inCart: false },
